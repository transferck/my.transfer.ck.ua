                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
							...
							<div class="form-group has-feedback row {{ $errors->has('partners_level') ? ' has-error ' : '' }}">
								{!! Form::label('partners_level', trans('forms.create_user_label_partners_level'), array('class' => 'col-md-3 control-label')); !!}
								<div class="col-md-9">
									{!! Form::select('partners_level', array('0' => '0', '1' => '1', '2' => '2', '3' => '3'), $user->partners_level, ['placeholder' => 'Выберите уровень', 'class' => 'custom-select form-control']) !!}
									@if ($errors->has('partners_level'))
										<span class="help-block">
											<strong>{{ $errors->first('partners_level') }}</strong>
										</span>
									@endif
								</div>
							</div>	
