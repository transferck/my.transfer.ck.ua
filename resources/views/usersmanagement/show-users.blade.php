                            ...
                            <table class="table table-striped table-sm data-table">
                                ...
                                <thead class="thead">
                                    <tr>
										...
										<th class="hidden-xs">{!! trans('usersmanagement.users-table.partners_level') !!}</th>
                                        <th class="hidden-xs">{!! trans('usersmanagement.users-table.phone') !!}</th>
                                ...
                                <tbody id="users_table">
                                    @foreach($users as $user)
                                        <tr>
                                            <td>{{$user->id}}</td>
                                            <td>{{$user->name}}</td>
                                            <td class="hidden-xs">{{$user->partners_level}}</td>
