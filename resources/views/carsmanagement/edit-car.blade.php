							...
							<div class="form-row">	
								...
								<div class="col-sm-3">
									<div class="form-group has-feedback {{ $errors->has('side_number') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											{!! Form::select('side_number',  array('70' => '70', '42' => '42', '46' => '46', '43' => '43', '29' => '29'), $car->side_number, ['placeholder' => trans('cars.side_numberPlaceholder'), 'id' => 'side_number', 'class' => 'custom-select form-control']) !!}
								...
								<div class="col-sm-3">
									<div class="form-group has-feedback {{ $errors->has('color') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											{!! Form::select('color',  array('white' => 'Белый', 'black' => 'Черный'), $car->color, ['placeholder' => trans('cars.colorPlaceholder'), 'id' => 'color', 'class' => 'custom-select form-control color-select']) !!}	
											@if ($errors->has('color'))
												<span class="help-block">
