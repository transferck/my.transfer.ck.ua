							...
							<div class="form-row">	
								...
								<div class="col-sm-3">
									<div class="form-group has-feedback {{ $errors->has('side_number') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											{!! Form::select('side_number',  array('11' => '11', '24' => '24', '26' => '26', '33' => '33', '42' => '42', '46' => '46', '64' => '64', '70' => '70', '73' => '73', '74' => '74', '78' => '78', '80' => '80', '84' => '84', '93' => '93'), $car->side_number, ['placeholder' => trans('cars.side_numberPlaceholder'), 'id' => 'side_number', 'class' => 'custom-select form-control']) !!}
									...
									<div class="form-group has-feedback {{ $errors->has('purchase_price') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											<div class="input-group">	
												...
												{!! Form::text('purchase_price', $car->purchase_price, array('id' => 'purchase_price', 'class' => 'form-control', 'placeholder' => trans('cars.purchase_pricePlaceholder'))) !!}
											</div>
							...
							<div class="form-row">	
								...
								<div class="col-sm-3">
									<div class="form-group has-feedback {{ $errors->has('car_status') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											{!! Form::select('car_status',  array('active' => 'На балансе', 'filmed' => 'Снят с рейса', 'sale' => 'Продано'), $car->car_status, ['placeholder' => trans('cars.car_statusPlaceholder'), 'id' => 'car_status', 'class' => 'custom-select form-control car_status-select']) !!}	
									...
									<div class="form-group has-feedback {{ $errors->has('img') ? ' has-error ' : '' }}">
										...
										<div class="col-md-12">
											<div class="input-group">
												...
												{!! Form::text('img', $car->img, array('id' => 'img', 'class' => 'form-control', 'placeholder' => trans('cars.imgPlaceholder'))) !!}
											</div>
											@if ($errors->has('img'))
												<span class="help-block">
