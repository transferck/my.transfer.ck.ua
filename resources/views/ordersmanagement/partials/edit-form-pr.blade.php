		...
		<div class="form-group has-feedback {{ $errors->has('date') ? ' has-error ' : '' }}">
			...
			<div class="col-md-12">
				<div class="input-group">
					...
					{!! Form::text('date', DateTime::createFromFormat('Y-m-d H:i:s', $order->datetime)->format('Y-m-d'), array('id' => 'date', 'class' => 'form-control flatpickr-input', 'placeholder' => trans('forms.create_order_ph_datetimepr'))) !!}
				</div>
				@if ($errors->has('date'))
					<span class="help-block">
		...
		<div class="form-group has-feedback {{ $errors->has('time') ? ' has-error ' : '' }}">
			...
			<div class="col-md-12">
				<div class="input-group">
					...
					{!! Form::text('time', DateTime::createFromFormat('Y-m-d H:i:s', $order->datetime)->format('H:i'), array('id' => 'time', 'class' => 'form-control flatpickr-input', 'placeholder' => trans('forms.create_order_ph_datetimepr'))) !!}
				</div>
				@if ($errors->has('time'))
					<span class="help-block">
