...
@endif
<p><b>{!! trans('forms.create_order_label_tickets') !!}: </b>				<span class="badge badge-pill badge-soft-dark">{{$order->tickets}}</span></p>
...
@else
	<p><b>{!! trans('forms.create_order_label_info') !!}: </b> <br>{{$order->info}}</p>	
@endif
