...
class OrdersManagementController extends Controller
{
    ...
    public function allOrdersApi(Request $request)
    {
        ...
        if (is_array($filters)) {
            ...
            if ( isset($filters['status']) ) {
                ...
                $orders->where([['status_order', '!=', 'cancel']]);
            }
        }
    ...
    public function create()
    {
        ...
        return view('ordersmanagement.create-order')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('ordersmanagement.edit-order')->with(compact('order'));
    }
    ...
    public function updateArrival(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(),
            [
                'fio'                  => 'required|max:255',
                'phone'                => 'required|max:32',
                'airport_world'        => 'required|max:255',
                //'terminal'             => 'required',
                'flight'               => 'required',
                'datetime'             => 'required',
                'address'              => 'required',
