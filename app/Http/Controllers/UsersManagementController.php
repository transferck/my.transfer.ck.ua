...
class UsersManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(),
            ...
            [
				...
				'phone.required' 		=> trans('auth.phoneNumberRequired'),
				'phone.min'              => trans('auth.phoneNumberMin'),
				'phone.numeric'          => trans('auth.phoneNumberNumeric'),
        ...
        $user = User::create([
			...
			'partners_level'   => $request->input('partners_level'),
    ...
    public function update(Request $request, $id)
    {
		...
		$user->partners_level = $request->input('partners_level');
